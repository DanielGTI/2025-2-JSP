          ...
          <section class="login_content">
            <form action="./Logar" method="post">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-github-alt"></i> JSP Gentelella!</h1>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form>
              ...
              <div>
                <a class="btn btn-default submit" href="index.html">Envir</a>
              </div>

              <div class="clearfix"></div>

              <div class="separator">
                <p class="change_link">Membro ?
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> JSP Gentelella!</h1>
                  <p>©2025 Todos os direitos reservados</p>
                </div>
              </div>
            </form>
